...
db.Building.hasMany(db.Room, { foreignKey: 'id' });
...
db.Room.hasMany(db.ClassMeeting, { foreignKey: 'id' });
db.ScheduleType.hasMany(db.Course, { foreignKey: 'id' });
db.Class.hasMany(db.ClassMeeting, { foreignKey: 'class_id' });
db.Class.hasMany(db.ClassEnrollment, { foreignKey: 'class_id' });
...
db.ClassMeeting.belongsTo(db.Room, { foreignKey: 'room_id' });
db.Room.belongsTo(db.Building, { foreignKey: 'building_id' });
db.ClassMeeting.belongsTo(db.Class, { foreignKey: 'class_id' });
db.Course.belongsTo(db.GradeMode, { foreignKey: 'grade_mode_id' });
db.ClassEnrollment.belongsTo(db.Class, { foreignKey: 'class_id' });
