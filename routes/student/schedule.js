            ...
            for (let i = 0; i < values.length; i++) {
                ...
                rule.all((date, index) => {
                    return events.push({
                        ...
                        overlap: true,
                        url: '/student/grades/term/' + values[i].term_id + '/class/' + values[i].class_id,
                        color: eventColor
                    });
                });
            }
